...
type ProgressByTargetId = Record<string, { completed: number; total: number }>;
...
type GradeTargetSelectorProps = {
	...
	targets: GradeTarget[];
	progressPromise: Promise<ProgressByTargetId>;
...
function GradeTargetResultsList({
	...
	const progressByTargetId = use(progressPromise);

	const searchTargets = useMemo(
		() => buildGradeTargetSearchTargets(targets, progressByTargetId),
		[targets, progressByTargetId],
	);
