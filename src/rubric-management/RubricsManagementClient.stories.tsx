...
import RubricsManagementClient from "./RubricsManagementClient.tsx";

const meta = {
	title: "Rubrics/RubricsManagementClient",
	component: RubricsManagementClient,
	args: {
		rubrics: [
			{
				id: "q1",
...
} satisfies Meta<typeof RubricsManagementClient>;
