...
Status: Active
Last Updated: 2026-06-11 (submission export internals refactor landed; R-006 Verified)
...
- Tier 1: 5 open, 0 in progress, 1 verified
...
| R-007 | Tier 1 | 72 | Progress metrics | Submission/global progress aggregates are business-critical and under-covered against edge combinations (zero-rubric questions, sparse assessments). | src/assessments/submissionProgress.ts, src/assessments/assessmentsProgress.ts | Open | [#24](https://github.com/QuentinRoy/grading/issues/24) | Unassigned | Sprint B | Pending | Add deterministic seeded tests with boundary scenarios and expected completed/total calculations. Treat as the remaining read-projection extraction from `docs/investigations/2026-05-26-read-write-separation-and-schema-change-resilience.md` (§5/§0): both modules already follow the ADR 0007 primitive/wrapper shape but lack a dedicated projection/test-hardening pass. |
