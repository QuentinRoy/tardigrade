...
- [MUI → Mantine migration](2026-06-30-mui-to-mantine-migration.md) — replace MUI with Mantine + a constrained app-owned semantic layer ([ADR 0011](../docs/adr/0011-adopt-mantine-constrained-design-system.md), [#222](https://github.com/QuentinRoy/grading/issues/222))
